...
public class SensorSettings : IExposable, IEquatable<SensorSettings>
{
    ...
    public bool Equals(SensorSettings other)
    {
        ...
        return string.Equals(Name, other.Name) && CooldownTime.Equals(other.CooldownTime) &&
               SendMessage == other.SendMessage && AlternativeSound == other.AlternativeSound &&
               SendWired == other.SendWired && SendWireless == other.SendWireless &&
               DetectAnimals == other.DetectAnimals && DetectFriendlies == other.DetectFriendlies &&
               DetectEnemies == other.DetectEnemies;
    }
    ...
    /// </summary>
    public static bool AssignModifiedFields(SensorSettings original, SensorSettings modified,
