...
public class CompStatBattery : CompPowerBattery
{
    ...
    private CompProperties_BatteryWithBar BatteryProps => props as CompProperties_BatteryWithBar;
    ...
    public override void PostPostApplyDamage(DamageInfo dinfo, float totalDamageDealt)
    {
        ...
        if (parent.Destroyed || ticksToExplode != 0 || dinfo.Def != DamageDefOf.Flame ||
            !(Rand.Value < ExplodeChancePerDamage) || !(StoredEnergy > MinChargeToExplode * statMaxEnergy))
        {
            return;
        }
