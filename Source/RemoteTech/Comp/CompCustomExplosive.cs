...
/// <summary>
///     An explosive with a timer. Can be triggered silently, but will revert to the vanilla wick if it takes enough
///     damage.
...
public class CompCustomExplosive : ThingComp
{
    ...
    private CompProperties_Explosive ExplosiveProps => (CompProperties_Explosive)props;

    public int WickTotalTicks => wickTotalTicks;
    ...
    public override void PostPreApplyDamage(DamageInfo dInfo, out bool absorbed)
    {
        ...
        else if (wickStarted && (dInfo.Def == DamageDefOf.Stun || wickIsSilent && dInfo.Def == DamageDefOf.EMP))
        {
            // silent wick can be stopped by EMP
            StopWick();
        }
        else if (!wickStarted && StartWickThreshold != 0 && parent.HitPoints <= StartWickThreshold &&
    ...
    protected virtual void Detonate()
    {
        ...
        var radius = exProps.explosiveRadius;
