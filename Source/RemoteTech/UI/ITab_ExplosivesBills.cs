                ...
                var option = new FloatMenuOptionWithTooltip(recipe.LabelCap, delegate
                    {
                        ...
                        if (map == null || !map.mapPawns.FreeColonists.Any(recipe1.PawnSatisfiesSkillRequirements))
                        {
                            Bill.CreateNoPawnsWithSkillDialog(recipe1);
                        }

                        var bill = recipe1.MakeNewBill();
