...
public static class Resources
{
    ...
    {
        public static readonly Material BatteryBarFilledMat =
            SolidColorMaterials.SimpleSolidColorMaterial(new Color(0.9f, 0.85f, 0.2f));

        public static readonly Material BatteryBarUnfilledMat =
    ...
    public static class Graphics
    {
        ...
        public static readonly Graphic FlareOverlayNormal =
            GraphicDatabase.Get<Graphic_Single>("rxFlare", ShaderDatabase.TransparentPostLight);

        public static readonly Graphic FlareOverlayStrong =
            GraphicDatabase.Get<Graphic_Single>("rxFlareStrong", ShaderDatabase.TransparentPostLight);

        public static readonly Graphic FlareOverlayGreen =
            GraphicDatabase.Get<Graphic_Single>("rxFlareGreen", ShaderDatabase.TransparentPostLight);

        public static readonly Graphic DetWireOverlayAtlas =
            GraphicDatabase.Get<Graphic_Single>("rxDetWire/detWireOverlayAtlas", ShaderDatabase.MetaOverlay);

        public static readonly Graphic DetWireOverlayEndpoint =
            GraphicDatabase.Get<Graphic_Single>("rxDetWire/connectionPointOverlay", ShaderDatabase.MetaOverlay);

        public static readonly Graphic DetWireOverlayCrossing =
            GraphicDatabase.Get<Graphic_Single>("rxDetWire/crossingOverlay", ShaderDatabase.MetaOverlay);
    ...
    public static class Textures
    {
        ...
        public static readonly Texture2D WallSmoothMenuIcon =
            ContentFinder<Texture2D>.Get("Things/Building/Linked/WallSmooth_MenuIcon");
